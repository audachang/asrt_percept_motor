...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\mypython\\Experiments\\asrt_percept_motor\\asrt_motor\\test_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "post_section_feedback" ---
    # Run 'Begin Experiment' code from performance_post_section
    import numpy as np
    
    bkRT = [0.5, 0.6, 0.4, 0.3]
    bkTrialNum=  1
    bkCorrectNum = 1
    ...
    # --- Prepare to start Routine "post_section_feedback" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('post_section_feedback.started', globalClock.getTime())
    ...
    post_section_feedbackComponents = [feedback_post_section, key_resp_4]
    for thisComponent in post_section_feedbackComponents:
    ...
    # --- Run Routine "post_section_feedback" ---
    ...
    # --- Ending Routine "post_section_feedback" ---
    for thisComponent in post_section_feedbackComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('post_section_feedback.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "post_section_feedback" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
